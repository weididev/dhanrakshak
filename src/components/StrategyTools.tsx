...
// 1. Profit First
export const ProfitFirstTool = ({ income }: any) => {
...
export const MillionaireMindTool = ({ income }: any) => {
  const jars = [
...
export const MasterMoneyTool = ({ assets }: any) => {
...
export const ERETool = ({ savingsRate }: any) => {
...
export const EverydayMillionairesTool = ({ netWorth }: any) => {
  const milestones = [
...
export const ZeroBasedTool = ({ income, totalOutflow, savings }: any) => {
