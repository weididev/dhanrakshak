...
import { Plus, Trash2, AlertCircle, CreditCard, Landmark } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center mb-8">
        ...
        >
          ...
          <span className="font-mono text-sm uppercase tracking-wider">{isAdding ? 'CANCEL' : 'ADD DEBT'}</span>
        </button>
      </div>
      ...
      {isAdding && (
        <div className="glass-panel p-6 rounded-xl neon-border border-[#ff0055]/30 mb-8 animate-in fade-in slide-in-from-top-4">
